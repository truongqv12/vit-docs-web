import type { HookCategory, HookDef } from "@/data/guides/custom-hooks/custom-hooks-data";
...
const hookExamples: Record<string, { en: string; vi: string }> = {
  ...
  "session-state": {
    en: "After compaction or handoff, Vit Engine can restore the active plan and todo list instead of treating the session as blank.",
    vi: "Sau compact hoặc handoff, Vit Engine có thể khôi phục plan và todo đang làm thay vì xem session như mới hoàn toàn.",
  },
  "usage-quota-cache-refresh": {
