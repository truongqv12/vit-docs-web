// v2.14.0 Stable workflows - skill-based approach với prefix /vit:
// /vit:cook dùng native Claude Tasks, /vit:fix hỗ trợ flags
export const stableWorkflows = [
  {
    ...
    steps: [
      {
        ...
        description: 'Dùng /vit:brainstorm hoặc nói "brainstorm ideas for [feature]" để khám phá',
    ...
    tip: '/clear bắt buộc sau /vit:plan trước /vit:cook',
  ...
  },
  {
    ...
    tip: '/vit:fix v2.0: RCA dựa trên bằng chứng. Flags: --auto, --review, --quick, --parallel',
    fixFlags: [
  ...
  },
  {
    ...
    steps: [
      {
        command: '/vit:cook "nhiệm vụ của bạn"',
    ...
    cookFlags: [
      ...
      { flag: '--tdd', desc: 'Viết test trước theo từng phase, dùng chung với mọi mode khác', color: 'cyan' }
    ],
    features: [
  ...
  },
  {
    ...
    steps: [
      {
        command: '/vit:bootstrap "mô tả ứng dụng của bạn"',
  ...
  },
  {
    ...
    steps: [
      {
        command: '/vit:preview --explain "chủ đề"',
      ...
      {
        command: '/vit:preview --html --explain "chủ đề"',
      ...
      {
        command: '/vit:preview --html --slides "chủ đề"',
  ...
  },
  {
    ...
    tip: '/vit:scout tích hợp code-reviewer để phát hiện edge cases trước review',
    features: [
      'Phát hiện edge case qua /vit:scout',
  ...
  },
  {
    ...
    tip: '/vit:plan validate decisions tự propagate xuống phase files',
    planFlags: [
      ...
      { flag: '--tdd', desc: 'Viết test trước theo phase, dùng chung với mọi flag khác', color: 'cyan' },
  ...
  },
  {
    ...
    features: [
      ...
      'Còn có: /vit:team research, /vit:team review, /vit:team debug'
    ],
  ...
  },
  {
    ...
    tip: '/vit:docs-seeker dùng context7 để lấy docs thư viện mới nhất',
    features: [
  ...
  },
  {
    ...
    tip: '/vit:ship tự nhận diện test runner, format version file và changelog style',
    features: [
  ...
  },
  {
    ...
    tip: '/vit:deploy tự nhận diện stack và xử lý biến môi trường, build steps và cấu hình platform',
    features: [
  ...
  },
  {
    ...
    tip: '/vit:llms tạo llms.txt chuẩn hóa để AI tools có thể hiểu nhanh codebase của bạn',
    features: [
  ...
  },
  {
    ...
    steps: [
      {
        command: '/vit:tech-graph "<topic hoặc system>"',
    ...
    tip: 'Kết hợp với /vit:preview --diagram để visual self-review (auto-detect collision, label overlap, arrow routing issue)',
    features: [
  ...
  {
    title: 'Điều Hướng Knowledge Graph',
    category: 'Planning & Review',
    level: 'Intermediate',
    duration: '~5-15 phút',
    stepCount: 2,
    bestFor: 'Hiểu codebase lạ qua phân tích cấu trúc trước khi lập kế hoạch',
    ...
    tip: 'Dùng --watch để cập nhật incremental khi code. MCP mode expose graph cho Claude truy vấn trực tiếp.',
    features: [
  ...
  },
  {
    ...
    tip: '/vit:retro 2w --compare --team tạo retro 2 tuần với so sánh kỳ trước và phân tích theo tác giả',
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      'Tích hợp với /vit:test để thực thi'
    ],
    borderColor: 'border-purple-500/20'
  },
  {
    ...
    tip: 'Kết hợp với /vit:security-scan để coverage vulnerability + threat toàn diện',
    features: [
      'STRIDE threat modeling framework',
      'OWASP vulnerability pattern matching',
      'Phân loại severity và ưu tiên',
      'Auto-fix lặp đi lặp lại tùy chọn theo pattern /vit:loop'
    ],
    borderColor: 'border-red-500/20'
  }
];
