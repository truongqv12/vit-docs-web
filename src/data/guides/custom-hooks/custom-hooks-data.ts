  ...
  },
  {
    ...
    hooks: [
      ...
      },
      {
        ...
        descEn: 'Validate ck:fix/vit:cook review artifacts (context-snippets, verification, review-decision, risk-gate) before finalize and ship-like actions. Optional via .claude/.ck.json; fail-open on crash.',
        descVi: 'Validate review artifacts của ck:fix/vit:cook (context-snippets, verification, review-decision, risk-gate) trước khi finalize và ship-like actions. Có thể bật trong .claude/.ck.json; fail-open khi crash.',
      },
    ],
  },
];
