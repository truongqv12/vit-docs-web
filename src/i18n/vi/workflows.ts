...
export const workflows = {
  ...
  'workflows.tip.scout.desc': 'Sử dụng `/vit:scout` để tìm nhanh các file liên quan trong codebase của bạn',
  'workflows.tip.debug.title': 'Debug trước khi sửa',
  'workflows.tip.debug.desc': 'Sử dụng `/vit:debug` trước để tìm nguyên nhân gốc rễ, sau đó dùng `/vit:fix` khi đã sẵn sàng',

  'workflows.tip.plan.title': 'Luôn bắt đầu với /vit:plan',
  'workflows.tip.plan.desc': 'Tạo một kế hoạch có cấu trúc trước, sau đó sử dụng `/vit:cook` để triển khai',
  ...
  'workflows.more.link': 'tài liệu đầy đủ từ trang web chính thức của Vit Engine',
  'workflows.guide.recipes_title': 'Quy Trình Mẫu',
  'workflows.v24.banner_intro': 'sử dụng command-based workflows.',
  'workflows.v24.banner_note': 'Sau /vit:plan, dùng /vit:cook để triển khai từng bước.',
  'workflows.tip.cook.title': 'Dùng /vit:cook để triển khai',
  'workflows.tip.cook.desc': 'Sau khi lên kế hoạch với `/vit:plan`, chạy `/clear` rồi `/vit:cook` để triển khai plan của bạn',
  'workflows.v25.cook_flags_title': 'Flags của /vit:cook',
